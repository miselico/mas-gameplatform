...
public class MyCleaner extends CleaningAgent {
	 ...
	 */
	//The mover has a move() method. This moves the robot one cell forward. Returns 0 if moving forward failed: hit a wall.
	private ForwardMover mover;
	//the rotator has a rotateCW() and rotateCCW() method for clockwise and counter-clockwise rotation
